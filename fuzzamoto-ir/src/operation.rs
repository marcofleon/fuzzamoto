...
impl fmt::Display for Operation {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Operation::CreateConnection => write!(f, "CreateConnection"),
...
impl Operation {
    ...
    pub fn get_output_variables(&self) -> Vec<Variable> {
        match self {
            ...
            Operation::CreateConnection => vec![Variable::Connection],
    ...
    pub fn get_input_variables(&self) -> Vec<Variable> {
        match self {
            ...
            Operation::CreateConnection => vec![Variable::Node, Variable::ConnectionType],
            Operation::BuildPayToWitnessScriptHash => {
