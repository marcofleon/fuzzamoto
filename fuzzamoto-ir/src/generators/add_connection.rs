...
impl<R: RngCore> Generator<R> for AddConnectionGenerator {
    ...
    fn name(&self) -> &'static str {
        match (self.handshake, self.connection_type) {
            (true, ConnectionType::Outbound) => "AddConnection:handshake:outbound",
            (true, ConnectionType::Inbound) => "AddConnection:handshake:inbound",
            (false, ConnectionType::Outbound) => "AddConnection:outbound",
            (false, ConnectionType::Inbound) => "AddConnection:inbound",
        }
    }
}
